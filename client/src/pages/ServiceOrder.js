...
function ServiceOrder() {
  ...
  const handleConfirmButtonClick = () => {
    const { firstName, lastName, email, contactNumber, appointmentDate, appointmentTime } = formValues;

    if (!firstName || !lastName || !email || !contactNumber || !appointmentDate || !appointmentTime) {
