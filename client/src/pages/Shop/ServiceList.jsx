...
const ServiceList = () => {
  ...
  const fetchServices = async () => {
    try {
      const response = await axios.get('http://localhost:8000/api/service/getServices');
  ...
  const deleteService = async (serviceId) => {
    try {
      const response = await axios.post('http://localhost:8000/api/service/deleteServiceController', {
  ...
  const updateService = async (serviceId) => {
    try {
      const response = await axios.post('http://localhost:8000/api/service/updateServiceController', {
        service_id: serviceId,
        service_name: newService.serviceName,
        price: newService.price,
        description: newService.description
